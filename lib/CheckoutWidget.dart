...
import 'package:deliveryapp/checkout/bloc.dart';

import 'checkout/event.dart';
import 'checkout/state.dart';

class CheckoutWidget extends StatelessWidget {
  CheckoutWidget({required Key key}) : super(key: key);
